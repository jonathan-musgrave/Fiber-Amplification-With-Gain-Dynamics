...
% Calculates the propagation of a given fiber defined by the parameteres in
% the struc fiber. signal and pumps define the optical fields, sys defines
% the system simulation parameters such as the axes and plotting. step_size
% is the non adaptable step_size of the propagation running
